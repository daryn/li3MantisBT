 ...
 */
$g_favicon_image = 'img/favicon.ico';

/**
 * Logo
 * @global string $g_logo_image
 */
$g_logo_image = 'mantis_logo.gif';
 ...
 */
$g_default_avatar = "%path%img/no_avatar.png";
...
$g_default_home_page = 'Dashboards::view';
